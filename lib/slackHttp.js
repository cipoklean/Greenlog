...
export const slackHttpsAgent = new https.Agent({
  keepAlive: false,
 ...
 */
export async function downloadSlackFile(urlStr, slackToken, maxRetries = 3) {
  let lastErr;
 ...
 */
export async function downloadSlackFileAsDataUrl(urlStr, slackToken) {
